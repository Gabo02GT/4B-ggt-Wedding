...
<section class="breadcumd__banner">
   <div class="container">
      <div class="breadcumd__wrapper center">
         <h1 class="left__content">our story</h1>
      ...
      <div class="row g-4 align-items-center">
         <div class="col-lg-6 col-md-12">
            <div class="love__story__content">
               ...
               <p>The couple takes seven full circles, walking clockwise around the agni, representing the seven principles and promises they make to each.Establishing and maintaining a healthy relationship is hard, and a therapist can help you navigate difficult times and develop essential relational skills.and a therapist can help you navigate difficult times and develop essential relational skills.</p>
            </div>
         </div>
         <div class="col-lg-6 col-md-12">
            <div class="love__story__thumb">
               <img src="styles/assets/img/love-story/love1.jpg" alt="love-image">
            </div>
         </div>
         <div class="col-lg-6 col-md-12 pt-70">
            <div class="love__story__thumb">
               <img src="styles/assets/img/love-story/love2.jpg" alt="love-image">
            </div>
         </div>
         <div class="col-lg-6 col-md-12 pt-70">
            <div class="love__story__content">
         ...
         <div class="col-lg-6 col-md-12">
            <div class="love__story__thumb">
               <img src="styles/assets/img/love-story/love3.jpg" alt="love-image">
            </div>
         </div>
         <div class="col-lg-6 col-md-12 pt-70">
            <div class="love__story__thumb">
               <img src="styles/assets/img/love-story/love4.jpg" alt="love-image">
            </div>
         </div>
         <div class="col-lg-6 col-md-12 pt-70">
            <div class="love__story__content">
