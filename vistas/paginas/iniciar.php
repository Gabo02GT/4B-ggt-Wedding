...
<section class="breadcumd__banner">
    <div class="container">
        <div class="breadcumd__wrapper center">
            <h1 class="left__content">Login</h1>
                    ...
                    <form class="p-5 bg-light" method="post">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" placeholder="Ingresa tu correo" id="email" name="ingresoEmail" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group form-check">
                            <label class="form-check-label">
                                ...
                                <label class="text-dark" for="">Recordar usuario</label>
                            </label>
                        </div>
<?php
